...
import com.natallialemiasheuskaya.data.entity.ErrorType;
                ...
                return upstream.onErrorResumeNext(new Function<Throwable, Publisher<? extends Model>>() {
                    ...
                    public Publisher<? extends Model> apply(Throwable throwable) throws Exception {
                        ...
                        if(throwable instanceof SocketTimeoutException) {
                            //сервер не доступен
                            return Flowable.error(new Error(String.valueOf(ErrorType.SERVER_NOT_AVAILABLE)));

                        }else if(throwable instanceof IOException){

                            Error error = new Error(String.valueOf(ErrorType.NO_INTERNET));
                        ...
                        return Flowable.error(new Error(String.valueOf(ErrorType.UNKNOWN)));
                    }
                });
            }
        };
